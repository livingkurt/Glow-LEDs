...
router
  ...
  .post(email_controller.send_email_subscription_emails_c);
...
router
  ...
  .post(cors(), email_controller.send_external_contact_emails_c);
...
router
  ...
  .post(email_controller.send_reset_password_emails_c);
router
  .route("/account_created")
  .post(email_controller.send_account_created_emails_c);
