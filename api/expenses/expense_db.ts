...
export default {
  ...
  get_range_expenses_expenses_db: async (start_date: string, end_date: string) => {
    try {
  ...
  get_monthly_expenses_expenses_db: async (year: string) => {
    try {
  ...
  get_daily_expenses_expenses_db: async (start_date: string, end_date: string) => {
    try {
