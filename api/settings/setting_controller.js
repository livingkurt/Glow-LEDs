...
export default {
  findAll_settings_c: async (req, res) => {
    const { query } = req;
    try {
  ...
  findById_settings_c: async (req, res) => {
    const { params } = req;
    try {
  ...
  create_settings_c: async (req, res) => {
    const { body } = req;
    try {
  ...
  update_settings_c: async (req, res) => {
  ...
  remove_settings_c: async (req, res) => {
    const { params } = req;
    try {
  ...
  database_settings_c: async (req, res) => {
    return res.status(201).send({ environment: config.ENVIRONMENT });
  },
};
