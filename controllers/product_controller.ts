...
export default {
  ...
  get_new_releases_products_c: async (req: any, res: any) => {
    const { params, body } = req;
    try {
      const product = await product_services.get_new_releases_products_s(
        params,
        body
      );
      if (product) {
  ...
  update_stock_products_c: async (req: any, res: any) => {
    const { params, body } = req;
    try {
      const product = await product_services.update_stock_products_s(
        params,
        body
      );
      if (product) {
  ...
  update_product_order_products_c: async (req: any, res: any) => {
    const { params, body } = req;
    try {
      const products = await product_services.update_product_order_products_s(
        params,
        body
      );
      if (products) {
  ...
  save_item_group_id_products_c: async (req: any, res: any) => {
    const { params, body } = req;
    try {
      const product = await product_services.save_item_group_id_products_s(
        params,
        body
      );
      if (product) {
