...
const affiliate_revenue_upload = async () => {
  ...
  try {
    ...
    // );
    const { data: last_months_rows } = await axios.get("https://www.glow-leds.com/api/orders/all_affiliate_code_usage/30");
    const { data: total_rows } = await axios.get("https://www.glow-leds.com/api/orders/all_affiliate_code_usage/0");
