...
<head>
  ...
  <meta property="og:image"
    content="https://glow-leds.herokuapp.comhttps://glow-leds.herokuapp.com/images/Glow_LEDs_Link_Logo.png">
    ...
    <div class="fade_in" style="height: 100%;">
      <header id="overlay"
        ...
        <div class="brand"><a href="/"><img class="zoom logo" height="125px"
              src="https://glow-leds.herokuapp.com/images/Glow_Logo.png" alt="Glow LEDs"></a><button
        ...
        <div style="display: flex; justify-content: center; margin: 0px auto; flex-direction: column;">
          <div class="logo_text" style="display: flex; justify-content: center; margin: 0px auto; align-items: center;">
            <a href="/"><img class="logo_2" src="https://glow-leds.herokuapp.com/images/Glow_Logo.png" alt="Glow LEDs"
