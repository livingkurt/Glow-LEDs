						...
						<tr style="font-family:helvetica;border-radius:4px">
							<td>
								<h4
									...
									Congrats ${affiliate.artist_name}! Your affiliate code, "${affiliate.public_code.promo_code.toUpperCase()}" was just used in an order!</h4>
							</td>
						</tr>
					</tbody>
				</table>
								...
								<tbody>
									<tr>
										<td colspan="2" style="font-size:20px;text-align:center">
											<h4 style="margin: 0px;">${months[date.getMonth()]} Affiliate Stats:</h4>
										</td>
									</tr>
									<tr>
										<td style="font-size:16px;height:30px text-ali"><h4>Code Uses: </h4></td>
										<td style="font-size:16px;height:30px text-ali"><h4>Earnings:</h4></td>
									</tr>
									<tr>
									<td style="font-size:16px;height:30px">${promo?.uses}</td>
									<td style="font-size:16px;height:30px">${promo?.earnings}</td>
									</tr>
