        ...
        <div>
          <div style="display: flex; justify-content: space-between; flex-wrap: wrap;">
            <div style="display: flex; flex-direction: column;">
              ...
              <h1 style="display: flex; font-size: 20px; margin: 0px;">Order Number: <a href="https://glow-leds.com/order/${props._id}" style="color:white; text-decoration:none">${props._id}</a></h1>
    ...
    ${props.orderItems.map(item => {
      let item_item = `<li style="border-bottom:0.1rem #c0c0c0 solid; display:flex; justify-content:space-between; margin-bottom:1rem; padding-bottom:1rem">
                        <div class="cart-image">
                          <img src="https://glow-leds.com/${item.display_image}" alt="product"style="border-radius:8px; margin-right:10px; max-height:10rem; max-width:10rem">
                        </div>
                        <div class="cart-name">
                          <div><a href="https://glow-leds.com/product/${item.product}" style="color:white; text-decoration:none">${item.name}</a></div>
