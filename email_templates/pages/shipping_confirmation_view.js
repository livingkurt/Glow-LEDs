  ...
  <body data-gr-c-s-loaded="true" style='background-color:#272727; color:white; font:1.6rem; height:100vh; margin:0'
    ...
    <div id="root" style="height:100%" height="100%">
      <div class="grid-container fade_in"
                ...
                <div
                  ...
                  <div style="display: flex; justify-content: space-between;">
                    <div style="display: flex; flex-direction: column;">
                      ...
                      <div>
                        <div>404 Kenniston Dr Apt D</div>
                        <div>Austin, TX 78752 United States</div>
                      </div>
                    </div>
        ...
        <footer class="footer"
          style="align-items:center; height: 9rem; background-color:#333; color:#fff; display:flex; grid-area:footer; justify-content:center"
          bgcolor="#333333">© 2020 Glow LEDs. All Rights Reserved</footer>
      </div>
    </div>
  </body>
