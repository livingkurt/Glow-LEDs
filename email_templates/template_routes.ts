      ...
      order: {
        ...
        payment: {
          ...
          charge: {
            ...
            client_secret:
              "pi_3K51dBHHW1jy2HDN0NIxElzd_secret_5pObVIZ80Sk2JeLYbM67P1rsj",
      ...
      order: {
        ...
        payment: {
          ...
          charge: {
            ...
            client_secret:
              "pi_3KLg7yHHW1jy2HDN1kauYrrA_secret_OFKo8Ra1jw9SjQHzPVfkBRcTN",
            confirmation_method: "automatic",
            created: 1643082930,
            currency: "usd",
            customer: null,
  ...
  async (req: { body: any }, res: { send: (arg0: string) => void }) => {
    const body = {
      email: {
        ...
        image: "",
        h2:
          "your shipment is on the way! Track your shipment to see the delivery status.",
        createdAt: "2020-11-19T16:24:12.273Z",
        updatedAt: "2021-07-06T18:52:09.037Z",
        images: [],
        p: "",
...
router.get(
  ...
  async (req: { body: any }, res: { send: (arg0: string) => void }) => {
    ...
    res.send(
      App({ body: review(body), title: "Enjoy 10% off your next purchase!" })
    );
  }
);
router.get(
...
router.get(
  ...
  async (req: { body: any }, res: { send: (arg0: string) => void }) => {
    ...
    res.send(
      App({ body: feature(body), title: "Thank you for sending us your art!" })
    );
  }
);
router.get(
  "/announcement",
  async (req: { body: any }, res: { send: (arg0: string) => void }) => {
    const email = await email_db.findAll_emails_db(
...
router.get(
  ...
  async (req: { body: any }, res: { send: (arg0: string) => void }) => {
    ...
    res.send(
      App({ body: reset_password(user), title: "Password Reset Instructions " })
    );
  }
);
router.get(
  ...
  async (req: { body: any }, res: { send: (arg0: string) => void }) => {
    ...
    res.send(
      App({ body: password_reset(user), title: "Password Reset Successful" })
    );
  }
);
...
router.get(
  ...
  async (req: { body: any }, res: { send: (arg0: string) => void }) => {
    ...
    res.send(
      App({ body: account_created(body), title: "Glow LEDs Account Created" })
    );
  }
);
