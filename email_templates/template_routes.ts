			...
			orderItems: [
				{
					...
					secondary_product: null,
					secondary_product_name: '',
					name: 'Glow Strings V2 50 LED / 3.5m',
					size: '',
					color_code: '',
					secondary_color_code: '',
					...
					package_height: 3,
					package_volume: 168,
					pathname: 'glow_strings_v2_50_led_3_5m',
					subcategory: 'leds',
				...
				},
				{
					...
					option_product_name: 'Glow Casings - 10',
					secondary_product: '61787f3abf66b4002ba72df5',
					secondary_product_name: 'Nano Glow Casings - Bubble Button (Atoms)',
					secondary_group_name: 'Style',
					name: 'Nano Glow Casings',
					size: '10',
					color: 'Clear',
					color_code: '#4b4b4b',
					secondary_color_code: '',
