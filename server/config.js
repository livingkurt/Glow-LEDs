...
const config = {
  ...
  // Production Address
  HEADQUARTERS_ADDRESS_1: process.env.HEADQUARTERS_ADDRESS_1,
  HEADQUARTERS_ADDRESS_2: process.env.HEADQUARTERS_ADDRESS_2,
  HEADQUARTERS_CITY: process.env.HEADQUARTERS_CITY,
  HEADQUARTERS_STATE: process.env.HEADQUARTERS_STATE,
  HEADQUARTERS_POSTAL_CODE: process.env.HEADQUARTERS_POSTAL_CODE,
  HEADQUARTERS_COUNTRY: process.env.HEADQUARTERS_COUNTRY,
  HEADQUARTERS_PHONE: process.env.HEADQUARTERS_PHONE,
