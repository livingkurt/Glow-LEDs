...
router.route("/:id/user").get(cart_controller.findByUser_carts_c).put(cart_controller.update_user_carts_c);
router.route("/:id/empty_cart").post(cart_controller.empty_carts_c);
router.route("/:id?/add_to_cart").post(cart_controller.add_to_cart_carts_c);
