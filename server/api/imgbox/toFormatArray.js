...
// export default function (data): Upload {
...
//   const isObjectWithUrl = data.every((value: { filename; url }) => {
...
//   const isObjectWithBuffer = data.every((value: { filename; buffer: Buffer }) => {
