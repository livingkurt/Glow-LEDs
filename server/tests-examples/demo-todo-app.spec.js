...
// async function checkNumberOfTodosInLocalStorage(page: Page, expected) {
//   return await page.waitForFunction(e => {
//     return JSON.parse(localStorage["react-todos"]).length === e;
//   }, expected);
// }

// async function checkNumberOfCompletedTodosInLocalStorage(page: Page, expected) {
//   return await page.waitForFunction(e => {
//     return JSON.parse(localStorage["react-todos"]).filter((todo) => todo.completed).length === e;
//   }, expected);
// }

// async function checkTodosInLocalStorage(page: Page, title) {
