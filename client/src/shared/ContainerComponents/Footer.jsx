      ...
      <div className="footer-image">
        ...
        <div className="mt-2rem wrap jc-c ">
          <div className="ml-10px fs-25px jc-b w-100per max-w-500px">
            ...
            {width > 500 && (
              <div className="mh-10px fs-40px">
                <a href="https://twitter.com/glow_leds" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
          ...
          <div className="jc-a w-100per">
            <div>
              ...
              <ul className="lst-none">
                ...
                <li className="ta-l mv-2rem">
                  <Link to="/collections/all/products/our_picks"> Our Picks ⭐</Link>
                </li>
                <li className="ta-l mv-2rem">
                  <Link to="/collections/all/products/discounted">On Sale! 💰</Link>
                </li>
                <li className="ta-l mv-2rem">
                  <Link to="/collections/all/products/category/merch/subcategory/stickers">Stickers</Link>
                </li>
                {/* <li className="ta-l mv-2rem">
            ...
            <div>
              ...
              <ul className="lst-none">
                ...
                <li className="ta-l mv-2rem">
                  <Link to="/collections/all/products/glowframez">Glowframez</Link>
                </li>
                <li className="ta-l mv-2rem">
