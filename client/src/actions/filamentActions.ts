...
export const listFilaments = (query: any) => async (
...
export const listMyFilament = () => async (
  dispatch: (arg0: { type: string; payload?: any }) => void,
  ...
  try {
    ...
    console.log({ listMyFilament: data });
...
export const saveFilament = (filament: any) => async (
  dispatch: (arg0: { type: string; payload: any }) => void,
  getState: () => { userLogin: { userInfo: any } }
) => {
  console.log({ filamentActions: filament });
  try {
...
export const detailsFilament = (pathname: string) => async (
  dispatch: (arg0: { type: string; payload: any }) => void
) => {
  try {
...
export const deleteFilament = (filamentId: string) => async (
