...
export const saveSurvey = (survey: any) => async (dispatch: (arg0: IDispatch) => void, getState: () => IGetState) => {
  try {
...
export const detailsSurvey = (id: string) => async (dispatch: (arg0: IDispatch) => void, getState: () => IGetState) => {
  try {
