...
export const register = (userData: any) => async (
...
export const login = (userData: any) => async (
  dispatch: (arg0: { type: string; payload: any }) => void
) => {
...
// Log user out
export const logout = (refresh_token: string) => async (
  dispatch: (arg0: { type: string; payload: any }) => void
) => {
...
export const reset_password = (email: string) => async (
  dispatch: (arg0: { type: string; payload: any }) => void
) => {
...
export const verify = (user_id: string) => async (
  dispatch: (arg0: { type: string; payload: any }) => void
) => {
  console.log({ user_id });
