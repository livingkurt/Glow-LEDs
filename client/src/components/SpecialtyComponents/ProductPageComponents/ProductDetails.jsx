          ...
          <TabPanel style={{ borderRadius: "0px 10px 10px 10px" }}>
            <div className="order-list responsive_table">
              ...
              <p className="w-100per jc-c">
                {" "}
                <label className="jc-c title_font mr-10px">
                  Hand Length:
                </label>{" "}
                <label>
                  Measures from Base of Palm to Tip of the Middle Finger
                </label>
              </p>
              <p className="w-100per jc-c">
                <label className=" jc-c title_font mr-10px">
        ...
        manuals[product.category] && (
          <TabPanel>
            ...
            {manuals[product.category].manual && (
              <img
                src={manuals[product.category].manual}
                alt="manual"
                className="w-100per"
              />
            )}
        ...
        <TabPanel style={{ borderRadius: "10px 0px 10px 10px" }}>
          ...
          <div className="p-1rem">
            ...
            {(product.category === "diffuser_caps" ||
              ...
              <div>
                <h2 className="ta-c">
                  Get your favorite caps in all of these new colors
                </h2>
