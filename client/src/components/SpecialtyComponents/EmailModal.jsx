...
const EmailModal = (props) => {
	...
	return (
		<div
			...
			className={`modal-floating ${complete ? 'max-h-325px' : 'max-h-300px'} max-w-500px fade_in ${width < 535 &&
				'mh-auto-20px'}`}
		>
			<span
					...
					<div className="h-100per jc-b column">
						...
						<ul>
							...
							<li>
								<button
									type="submit"
									className="btn w-100per mt-2rem bg-white ft-primary title_font bob"
								>
									Join Us
								</button>
							</li>
