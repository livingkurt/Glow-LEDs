            ...
            <div>
              ...
              <ul className="lst-none">
                <li className="ta-l mv-2rem">
                              ...
                              <Link className="gradient-btn special_font"to="/collections/all/products/glow_stringz_v2_50_led_3_5m"><span>GLOW STRINGZ V2</span></Link>
                          ) : (
                            <Link className=""to="/collections/all/products/glow_stringz_v2_50_led_3_5m"><span>GLOW STRINGZ V2</span></Link>
                          )}
