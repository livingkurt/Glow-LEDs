...
function FlexContainer(props) {
  ...
  const styles = {
    ...
    alignItems: props.v_center ? "center" : props.v_left ? "flex-start" : props.v_right ? "flex-end" : props.v_between ? "space-between" : props.v_around ? "space-around" : props.v_evenly ? "space-evenly" : '',
