...
export const buyLabel = createAsyncThunk("shipping/buyLabel", async ({ orderId }, thunkApi) => {
  try {
...
export const createLabel = createAsyncThunk("shipping/createLabel", async ({ orderId, speed }, thunkApi) => {
  try {
...
export const createCustomLabel = createAsyncThunk(
  ...
  async ({ selectedRateId, shipmentId }, thunkApi) => {
    try {
...
export const getShipments = createAsyncThunk("shipping/getShipments", async (_params, thunkApi) => {
  try {
...
export const createTracker = createAsyncThunk("shipping/createTracker", async ({ orderId }, thunkApi) => {
  try {
...
export const createReturnLabel = createAsyncThunk("shipping/createReturnLabel", async ({ orderId }, thunkApi) => {
  try {
...
export const shippingRates = createAsyncThunk("shipping/shippingRates", async ({ order }, thunkApi) => {
  try {
...
export const customShippingRates = createAsyncThunk(
  ...
  async ({ toShipping, fromShipping, parcel }, thunkApi) => {
    try {
...
export const refundLabel = createAsyncThunk("shipping/refundLabel", async ({ orderId, isReturnTracking }, thunkApi) => {
  try {
...
export const generateCSVLabel = createAsyncThunk("shipping/generateCSVLabel", async ({ orderId }, thunkApi) => {
  try {
...
export const createPickup = createAsyncThunk(
  ...
  async ({ readyTime, latestTimeAvailable, orderIds }, thunkApi) => {
    try {
...
export const confirmPickup = createAsyncThunk(
  ...
  async ({ pickupId, rateId, orders }, thunkApi) => {
    try {
...
export const differentShippingRates = createAsyncThunk("shipping/differentShippingRates", async (order, thunkApi) => {
  try {
...
// export const createLabel = createAsyncThunk("shipping/createLabel", async ({ order, shipping_rate, speed }, thunkApi) => {
...
// }
// });
// export const customShippingRates = createAsyncThunk("shipping/customShippingRates", async (data, thunkApi) => {
//   try {
...
//   async ({ order, tracking_number, label }, thunkApi) => {
//     try {
//       const { data } = await axios.put(
...
// export const createReturnLabel = createAsyncThunk("shipping/createReturnLabel", async ({ order, shipping_rate }, thunkApi) => {
