...
export const listAffiliates = createAsyncThunk("affiliates/listAffiliates", async (query, thunkApi) => {
  try {
...
export const generateSponsorCodes = createAsyncThunk("affiliates/generateSponsorCodes", async (id, thunkApi) => {
  try {
...
export const monthlyCheckin = createAsyncThunk(
  ...
  async ({ affiliateId, questionsConcerns, numberOfContent, month, year }, thunkApi) => {
    try {
