...
export const detailsSurvey = createAsyncThunk("surveys/detailsSurvey", async (id: string, thunkApi: any) => {
  try {
...
export const getSurveysByLink = createAsyncThunk("surveys/getSurveysByLink", async (link: string, thunkApi: any) => {
  try {
