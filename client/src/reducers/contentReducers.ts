...
export const contentListReducer = (state = { contents: [] }, action: IAction) => {
  switch (action.type) {
...
export const contentDetailsReducer = (state = { content: { reviews: [] } }, action: IAction) => {
  switch (action.type) {
...
export const contentDeleteReducer = (state = { content: {} }, action: IAction) => {
  switch (action.type) {
...
export const contentSaveReducer = (state = { content: {} }, action: IAction) => {
  switch (action.type) {
