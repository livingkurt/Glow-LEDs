...
export const featureListReducer = (state = { features: [] }, action: IAction) => {
  switch (action.type) {
...
export const featureDetailsReducer = (state = { feature: {} }, action: IAction) => {
  switch (action.type) {
...
export const featureDeleteReducer = (state = { feature: {} }, action: IAction) => {
  switch (action.type) {
...
export const featureSaveReducer = (state = { feature: {} }, action: IAction) => {
  switch (action.type) {
