...
export const paletteListReducer = (state = { palettes: [] }, action: IAction) => {
  switch (action.type) {
...
export const paletteDetailsReducer = (state = { palette: {} }, action: IAction) => {
  switch (action.type) {
...
export const paletteDeleteReducer = (state = { palette: {} }, action: IAction) => {
  switch (action.type) {
...
export const paletteSaveReducer = (state = { palette: {} }, action: IAction) => {
  switch (action.type) {
