...
export const settingListReducer = (state = { settings: [] }, action: IAction) => {
  switch (action.type) {
...
export const settingDetailsReducer = (state = { setting: {} }, action: IAction) => {
  switch (action.type) {
...
export const showHideSearchBarReducer = (state = { setting: {} }, action: IAction) => {
  switch (action.type) {
...
export const settingDeleteReducer = (state = { setting: {} }, action: IAction) => {
  switch (action.type) {
...
export const settingSaveReducer = (state = { setting: {} }, action: IAction) => {
  switch (action.type) {
