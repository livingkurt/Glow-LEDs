...
export const parcelListReducer = (state = { parcels: [] }, action: IAction) => {
  switch (action.type) {
...
export const parcelDetailsReducer = (state = { parcel: {} }, action: IAction) => {
  switch (action.type) {
...
export const parcelDeleteReducer = (state = { parcel: {} }, action: IAction) => {
  switch (action.type) {
...
export const parcelSaveReducer = (state = { parcel: {} }, action: IAction) => {
  switch (action.type) {
