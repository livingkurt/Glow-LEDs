...
export const chipListReducer = (state = { chips: [] }, action: IAction) => {
  switch (action.type) {
...
export const chipDetailsReducer = (state = { chip: {} }, action: IAction) => {
  switch (action.type) {
...
export const chipDeleteReducer = (state = { chip: {} }, action: IAction) => {
  switch (action.type) {
...
export const chipSaveReducer = (state = { chip: {} }, action: IAction) => {
  switch (action.type) {
