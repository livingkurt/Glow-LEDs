...
export const emailListReducer = (state = { emails: [] }, action: IAction) => {
  switch (action.type) {
...
export const emailDetailsReducer = (state = { email: { reviews: [] } }, action: IAction) => {
  switch (action.type) {
...
export const emailDeleteReducer = (state = { email: {} }, action: IAction) => {
  switch (action.type) {
...
export const emailSaveReducer = (state = { email: {} }, action: IAction) => {
  switch (action.type) {
