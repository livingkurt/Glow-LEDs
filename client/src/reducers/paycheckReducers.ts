...
export const paycheckListReducer = (state = { paychecks: [] }, action: IAction) => {
  switch (action.type) {
...
export const paycheckDetailsReducer = (state = { paycheck: {} }, action: IAction) => {
  switch (action.type) {
...
export const paycheckDeleteReducer = (state = { paycheck: {} }, action: IAction) => {
  switch (action.type) {
...
export const paycheckSaveReducer = (state = { paycheck: {} }, action: IAction) => {
  switch (action.type) {
