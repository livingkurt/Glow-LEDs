...
export const categoryListReducer = (state = { categorys: [] }, action: IAction) => {
  switch (action.type) {
...
export const categoryDetailsReducer = (state = { category: {} }, action: IAction) => {
  switch (action.type) {
...
export const categoryDeleteReducer = (state = { category: {} }, action: IAction) => {
  switch (action.type) {
...
export const categorySaveReducer = (state = { category: {} }, action: IAction) => {
  switch (action.type) {
