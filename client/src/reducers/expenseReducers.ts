...
export const expenseListReducer = (state = { expenses: [] }, action: IAction) => {
  switch (action.type) {
...
export const expenseDetailsReducer = (state = { expense: { reviews: [] } }, action: IAction) => {
  switch (action.type) {
...
export const expenseDeleteReducer = (state = { expense: {} }, action: IAction) => {
  switch (action.type) {
...
export const expenseSaveReducer = (state = { expense: {} }, action: IAction) => {
  switch (action.type) {
