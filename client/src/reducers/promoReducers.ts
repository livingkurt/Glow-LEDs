...
export const promoListReducer = (state = { promos: [] }, action: IAction) => {
  switch (action.type) {
...
export const promoDetailsReducer = (state = { promo: { reviews: [] } }, action: IAction) => {
  switch (action.type) {
...
export const promoDeleteReducer = (state = { promo: {} }, action: IAction) => {
  switch (action.type) {
...
export const promoSaveReducer = (state = { promo: {} }, action: IAction) => {
  switch (action.type) {
