...
export const affiliateListReducer = (state = { affiliates: [] }, action: IAction) => {
  switch (action.type) {
...
export const affiliateDetailsReducer = (state = { affiliate: {} }, action: IAction) => {
  switch (action.type) {
...
export const affiliateDeleteReducer = (state = { affiliate: {} }, action: IAction) => {
  switch (action.type) {
...
export const affiliateSaveReducer = (state = { affiliate: {} }, action: IAction) => {
  switch (action.type) {
