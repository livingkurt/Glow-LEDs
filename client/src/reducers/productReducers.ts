...
export const productListReducer = (state = { products: [], totalPages: 0, currentPage: 1 }, action: IAction) => {
  switch (action.type) {
...
export const productDetailsReducer = (state = { product: { reviews: [] } }, action: IAction) => {
  switch (action.type) {
...
export const productDeleteReducer = (state = { product: {} }, action: IAction) => {
  switch (action.type) {
...
export const productSaveReducer = (state = { product: {} }, action: IAction) => {
  switch (action.type) {
...
export const productImagesReducer = (state = { images: [] }, action: IAction) => {
  switch (action.type) {
...
export const productReviewSaveReducer = (state = {}, action: IAction) => {
  switch (action.type) {
...
export const productReviewDeleteReducer = (state = {}, action: IAction) => {
  switch (action.type) {
