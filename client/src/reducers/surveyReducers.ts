...
export const surveyListReducer = (state = { surveys: [] }, action: IAction) => {
  switch (action.type) {
...
export const surveyDetailsReducer = (state = { survey: {} }, action: IAction) => {
  switch (action.type) {
...
export const surveyDeleteReducer = (state = { survey: {} }, action: IAction) => {
  switch (action.type) {
...
export const surveySaveReducer = (state = { survey: {} }, action: IAction) => {
  switch (action.type) {
