...
export const MY_CATEGORY_LIST_REQUEST = 'MY_CATEGORY_LIST_REQUEST';
export const MY_CATEGORY_LIST_SUCCESS = 'MY_CATEGORY_LIST_SUCCESS';
export const MY_CATEGORY_LIST_FAIL = 'MY_CATEGORY_LIST_FAIL';
