  ...
  return (
    <Container maxWidth="lg">
      ...
      <Box py={2}>
        ...
        <Box display="flex" flexDirection={{ xs: "column", md: "row" }} alignItems="center" mb={2}>
          <Box flexGrow={1} mr={{ md: 2 }}>
            ...
            <Typography variant="body1" paragraph>
              ...
              each finger individually is so fascinating and a lot to wrap your head around. So of course, my best
              friend and I began to learn to glove not too long after that first lightshow. We spent all day every day
              learning, finger rolls, liquid, whips, wave tuts, flails, all in order, we practiced each concept until
              they were perfect then moved to the next concept and so on. Over the years gloving has changed a lot,
              first it was finger rolls and whips, then wave tuts, and now its clusters! What new thing will come next?
              What makes gloving so amazing is the fact that you can do it anywhere, and I mean literally anywhere.
              Sitting on the bus, waiting at the bank, walking to the kitchen, literally anywhere!! With that ability
              you can become great in a very short amount of time. It almost seems like the new glovers are getting good
              faster than ever within just a few months now. What a beautiful thing.
            </Typography>
          </Box>
        ...
        <Typography variant="body1" paragraph>
          If you're going to create, why not try to innovate. Or at least make it a little better haha. My mind is on a
          constant stream of what can I create that doesn't exist and what can I do to make something better. Glow LEDs
          is built on community needs and ideas. I am apart of this community just as much as you. I want our technology
          to improve as we do. The idea for Diffuser Caps was born out of this need. How can you have more complex
          designs and shapes to be recognizable when gloving? The breakthrough was putting the cap on the outside of the
          glove! That was our first really big idea and we haven't stopped there. We came out with Glowskinz after that,
          which have become a staple in the gloving community, as well as our upgraded Glowstringz V2. Giving a whole
          new look to back lighting for lightshows as well as home and festival decoration. Glow LEDs is always ready
          for suggestions on product ideas and product improvements. What's the point of selling a product that the
          community is not happy with? We love the progress and direct line communication with the people that matter.
          Thank you for all of the support and love. We will keep pushing the envelope to new heights for you. As long
          you keep glowing just as bright as you can!
        </Typography>
