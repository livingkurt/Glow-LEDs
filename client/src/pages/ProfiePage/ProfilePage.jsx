...
//   const [loading_earnings, set_loading_earnings] = useState(true);
...
//             <label>{!loading_earnings && determine_code_tier(affiliate, current_month_number_of_uses)}% Off</label>
//           </div>
//           {affiliate.sponsor && (
//             <>
//               <div className="mb-20px">
...
//           <Loading loading={loading_earnings} error={error}>
...
//                 >
//                   <th>Current Month</th>
//                   <th>${!loading_earnings && parseFloat(current_month_revenue).toFixed(2)}</th>
//                   <th>
//                     $
//                     {!loading_earnings &&
//                       parseFloat(
...
//                       ).toFixed(2)}
//                   </th>
//                   <th>{!loading_earnings && current_month_number_of_uses}</th>
//                 </tr>
//                 <tr
//                   style={{
//                     backgroundColor: "#656a87"
