...
const ProductOptions = ({ currentOptions, customizedProduct, product, my_cart }) => {
    ...
    <Box>
      ...
      <Box mt={2}>
        <GLButtonV2
          ...
          tooltip={isOptionCountDifferent(product, customizedProduct) && "You must select all options to Add To Cart"}
