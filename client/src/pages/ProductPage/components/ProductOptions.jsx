...
//             <div>
//               <SecondaryDropdown
//                 label={`${product.secondary_group_name ? product.secondary_group_name : "Design"}:`}
//                 color_code={color_code}
//                 onChange={e => {
//                   const secondary = e.target.value;
//                   dispatch(update_secondary({ secondary, product, current_user, product }));
//                   update_url({
//                     color,
//                     secondary_color,
//                     option: option_product_name,
...
//                   });
//                 }}
//                 value={secondary_product_object}
//                 options={product.secondary_products}
//                 product={product}
//               />
//               {/* <div className={`ai-c h-25px mv-20px ${width < 1150 ? "jc-b" : ""}`}>
//             <InputLabel className="mv-0px mr-10px title_font">
//               {product.secondary_group_name ? product.secondary_group_name : "Design"}:
//             </InputLabel>
...
//                 defaultValue={JSON.stringify(secondary_product_object)}
//               >
//                 <MenuItem key={1} defaultValue="">
//                   Choose {product.secondary_group_name && product.secondary_group_name}
//                 </MenuItem>
//                 {product.secondary_products.map((secondary, index) => (
//                   <MenuItem key={index} value={JSON.stringify(secondary)}>
//                     {determine_secondary_product_name(secondary.name, product)}
//                   </MenuItem>
//                 ))}
//               </Select>
...
//               <Grid item xs={12}>
//                 <ColorDropdown
//                   label={`${product.color_group_name ? product.color_group_name : "Color"}:`}
//                   color_code={color_code}
//                   onChange={e => {
...
//                     });
//                   }}
//                   value={color_product_object}
//                   options={color_products}
//                 />
//                 {/* <div className={`ai-c h-25px mb-25px ${width < 1150 ? "jc-b" : ""}`}>
//                 <InputLabel className="mv-0px mr-10px title_font">
//                   {product.color_group_name ? product.color_group_name : "Color"}:
...
//                         .filter(item => item.filament && item.filament.active)
//                         .map((color, index) => (
//                           <MenuItem key={index} value={JSON.stringify(color)}>
//                             {color.name.split(" ")[0]}
//                           </MenuItem>
//                         ))}
//                     </Select>
...
//                 <Grid item xs={12}>
//                   <ColorDropdown
//                     label={`${product.secondary_color_group_name ? product.secondary_color_group_name : "Color"}:`}
...
//                       });
//                     }}
//                     value={secondary_color_product_object}
//                     options={secondary_color_products}
//                   />
//                   {/* <div className={`ai-c h-25px mb-25px ${width < 1150 ? "jc-b" : ""}`}>
//                   <InputLabel className="mv-0px mr-10px title_font">
//                     {product.secondary_color_group_name ? product.secondary_color_group_name : "Secondary Color"}:
...
//                           .filter(item => item.filament && item.filament.active)
//                           .map((secondary_color, index) => (
//                             <MenuItem key={index} value={JSON.stringify(secondary_color)}>
//                               {secondary_color.name.split(" ")[0]}
//                             </MenuItem>
//                           ))}
//                       </Select>
...
//                 <hr />
//                 <h3 className="title_font jc-c fs-20px"> {sizes_conversion(size)}</h3>{" "}
//                 <div className="jc-c ta-c w-100oer lh-30px">
//                   {product?.name?.includes("V1")
//                     ? 'We recommend getting a size up compared to other company"s gloves'
//                     : "We recommend getting the same size you usually get from other companies"}
//                 </div>
//                 <div className="mb-10px jc-b w-100per">
//                   <div className="title_font"> Hand Length:</div>{" "}
//                   <div className="title_font">{size && sizes_short(width, product.name)[size]?.hand_length} inches</div>
//                 </div>
//                 <div className="jc-b w-100per mb-10px">
//                   <div className="title_font"> Hand Width:</div>{" "}
//                   <div className="title_font">{size && sizes_short(width, product.name)[size]?.hand_width} inches</div>
//                 </div>
//                 {determine_sampler(product?.name) && (
//                   <>
//                     <div className="jc-c ta-c w-100oer mt-20px lh-30px">
//                       Worried about the fit? We've got your back with our:
//                     </div>
//                     <div>
//                       {product.category === "gloves" &&
