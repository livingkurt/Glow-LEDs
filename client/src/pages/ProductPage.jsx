            ...
            <div>
              <FlexContainer column styles={{ padding: "1rem" }}>
                ...
                {!product.video ?
                  ...
                  <Title styles={{ fontSize: 30, textAlign: "center", width: "100%", justifyContent: "center" }} >Video Coming Soon!</Title>
                  : <FlexContainer h_center column >
                    <Title styles={{ fontSize: 20, textAlign: "center", width: "100%", justifyContent: "center" }} >Watch the Video Below to Learn More</Title>
