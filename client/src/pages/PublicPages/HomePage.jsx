...
const HomePage = props => {
  ...
  return (
    <div className="main_container">
            ...
            {slideshow.length > 0 ? (
              <div className="carousel-wrapper pos-rel">
                ...
                >
                  ...
                  <div className="jc-c">
                    <h2
                      className={`mb-1rem ta-c lh-25px ${determine_innovators_font_size(
                        width
                      )}`}
                    >
                  ...
                  <div className="jc-c">
                    <form
                      ...
                      className="jc-c w-100per mv-20px"
                    >
          ...
          <div>
            {slideshow.length > 0 ? (
              ...
              >
                ...
                <div className="jc-c">
                  <h2
                    className={`mb-1rem ta-c lh-30px ${determine_innovators_font_size(
                      width
                    )}`}
                  >
                    Innovators of Gloving and Flow Art Technology
      ...
      >
        ...
        <div className="jc-c">
          <div>
            ...
            >
              Here at Glow LEDs we aim to be the biggest innovators in the
              gloving industry.
            </p>
            ...
            >
              Some of our most popular inventions include EXO Diffusers, Decals,
              Diffuser Caps and Glowskinz! We've even put our own spin on whites
              and batteries! Plus we're one of the few places where you can
            ...
            >
              We are ran by a very small team of people who are dedicated to
              listening to the community and creating what's most wanted. Our
              products are made by hand to order, so every order is made with
              love.
            </p>
          </div>
        </div>
      ...
      <h4 className="fs-25px mv-8px ta-c jc-c title_font lh-30px">
        Featured Artists
      </h4>
      <div className={`${width > 1019 ? "jc-b" : "jc-c"} wrap`}>
        {features &&
      ...
      <div
        className={`small_home_page_cards ${width > 1019
          ? "jc-b"
          : "jc-c"} wrap`}
      >
