            ...
            {features && (
              <ul className="products" style={{ marginTop: 0, textDecoration: "none" }}>
                {features
                  ...
                  .map(
                    (feature, index) =>
                      !feature.hidden && <Feature size="300px" key={index} feature={feature} category={props.match.params.category} />
                  )}
              </ul>
            )}
          </div>
              ...
              <ul className="products" style={{ marginTop: 0, textDecoration: "none" }}>
                {features
                  ...
                  .map(
                    (feature, index) =>
                      !feature.hidden && (
                        <FeatureSmallScreen size="300px" key={index} feature={feature} category={props.match.params.category} />
                      )
                  )}
              </ul>
            )}
