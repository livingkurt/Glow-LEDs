      ...
      <div className="inner_content">
        ...
        <div>
          ...
          <ReadMore width={700} length={200} pre={true} className="paragraph_font" style={{ flex: "0 1 30%" }}>
            From the very first time I saw a lightshow back in 2014 I was hooked! The ability to manipulate light with each finger
            individually is so fascinating and a lot to wrap your head around. So of course, my best friend and I began to learn to glove
            not too long after that first lightshow. We spent all day every day learning, finger rolls, liquid, whips, wave tuts, flails,
            all in order, we practiced each concept until they were perfect then moved to the next concept and so on. Over the years gloving
            has changed a lot, first it was finger rolls and whips, then wave tuts, and now its clusters! What new thing will come next?
            What makes gloving so amazing is the fact that you can do it anywhere, and I mean literally anywhere. Sitting on the bus,
            waiting at the bank, walking to the kitchen, literally anywhere!! With that ability you can become great in a very short amount
            of time. It almost seems like the new glovers are getting good faster than ever within just a few months now. What a beautiful
            thing.
          </ReadMore>
          <h2 className="about_names" style={{ marginTop: 0, marginBottom: "25px" }}>
            The Problem
          ...
          <div>
            <ReadMore width={700} length={200} pre={true} className="paragraph_font">
              ...
              was putting the cap on the outside of the glove! That was our first really big idea and we haven't stopped there. We came out
              with Glowskinz after that, which have become a staple in the gloving community, as well as our upgraded Glowstringz V2. Giving
              a whole new look to back lighting for lightshows as well as home and festival decoration. Glow LEDs is always ready for
              suggestions on product ideas and product improvements. What's the point of selling a product that the community is not happy
              with? We love the progress and direct line communication with the people that matter. Thank you for all of the support and
              love. We will keep pushing the envelope to new heights for you. As long you keep glowing just as bright as you can!
            </ReadMore>
          </div>
          ...
          <Loading loading={loading_team} error={error}>
            <div>
              <div className="product_big_screen">
                {teams && (
                  <ul className="products" style={{ marginTop: 0, textDecoration: "none" }}>
                    {teams.map((team, index) => !team.hidden && <Team size="300px" key={index} team={team} />)}
                  </ul>
                )}
              </div>
              ...
              <div className="product_small_screen none">
                {teams && (
                  <ul className="products" style={{ marginTop: 0, textDecoration: "none" }}>
                    {teams.map((team, index) => !team.hidden && <TeamSmallScreen size="300px" key={index} team={team} />)}
                  </ul>
                )}
              </div>
            </div>
