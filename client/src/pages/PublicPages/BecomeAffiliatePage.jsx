		...
		<div className="main_container p-20px ">
			...
			<div className="paragraph_font">
				...
				<ul style={{ padding: '0 18px', listStyle: 'disc' }}>
					...
					<li>
						Invited to Exclusive Affiliate Meeting Once a month to hang out and discuss new products and
						ideas
					</li>
			...
			<div className="paragraph_font">
				...
				<ul style={{ padding: '0 18px', listStyle: 'disc' }}>
					...
					<li>
						Choice of one free product for each product release as well as whatever products we want to give
						you
					</li>
			...
			<div className="paragraph_font">
				...
				<ul style={{ padding: '0 18px', listStyle: 'disc' }}>
					...
					<li>
						Each member sends Glow LEDs a lightshow with a Glow LEDs product to be featured, at least once a
						month
					</li>
					<li>Host X Number of Gloving Competition a year</li>
					<li>With choice of product requires you to make a lightshow/product review video with them</li>
