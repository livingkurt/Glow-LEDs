  ...
  return (
    <div className="form">
      <Helmet>
        ...
        <link
          rel="canonical"
          href="https://www.glow-leds.com/account/decision"
        />
        <meta
          property="og:url"
          content="https://www.glow-leds.com/account/decision"
        />
      </Helmet>
      <form>
        <ul className="form-container">
          ...
          <li>
            <p>
              If you do not know your order number please contact support for
              assistance
            </p>
          </li>
          <li>
