...
const TeamTermsPage = () => {
  return (
    <div className="main_container p-20px ">
      ...
      <h1 className="ta-c">Team Terms & Conditions</h1>
      ...
      <div className="paragraph_font">
        ...
        <ul style={{ padding: "0 18px", listStyle: "disc" }}>
          <li>Personal 20% off Promo Code that can be used on any purchase with your team account</li>
          <ul style={{ padding: "0 18px", listStyle: "disc" }}>
          ...
          <li>Added to the Official Glow LEDs Team Facebook Chat, and Team Group</li>
          <li>Invited to Exclusive Team Meeting Once a month to hang out and discuss new products and ideas</li>
      ...
      <div className="paragraph_font">
        ...
        <ul style={{ padding: "0 18px", listStyle: "disc" }}>
          ...
          <li>Personal 30% off Promo Code that can be used on any purchase with your team account</li>
          <ul style={{ padding: "0 18px", listStyle: "disc" }}>
            <li>Promo Code can increase based on number of uses</li>
          </ul>
