...
import { listUsers, update } from '../../actions/userActions';
...
const PlaceOrderPage = (props) => {
	...
	const { userInfo, loading: user_loading } = userLogin;
				...
				<div className="placeorder-info">
							...
							<div className="w-100per">
								{userInfo && userInfo.hasOwnProperty('first_name') ? (
										...
										<ul className="shipping-container">
											<li>
												<pre className="phrase_font">
													...
													<button className="btn nav title_font">Logout</button>
												</pre>
											</li>
											<li>
												<button
									...
									<ul className="shipping-container">
										...
										<li>
											<button className="btn primary" onClick={() => login_user()}>
												{/* <button className="btn primary" onClick={() => next_step('shipping')}> */}
												Continue
											</button>
										</li>
					...
					<div>
						<div className="jc-b">
							...
							{!show_review && (
								<button className="btn secondary mv-10px" onClick={() => show_hide_steps('review')}>
									Edit
								</button>
							)}
						</div>
