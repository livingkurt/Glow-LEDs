  ...
  if (previous_price) {
    return (
      <label className="fs-18px">
        ...
        <label>
          {" "}
          ({(100 * (1 - price / previous_price)).toFixed(2)}% Off){" "}
        </label>
        <label>
          <del style={color}>
    ...
    if (
      sale_price !== 0 &&
      today >= new Date(sale_start_date) &&
      today <= new Date(sale_end_date)
    ) {
      return (
        <label className="fs-18px">
      ...
      return (
        <label className="fs-18px">${price ? price.toFixed(2) : price}</label>
      );
    }
  }
};
    ...
    if (
      ...
      return (
        <label className="fs-18px">
          ...
          <label>
            {" "}
            ({(100 * (1 - product.sale_price / product.price)).toFixed(2)}% Off){" "}
          </label>
          <label>
            <del style={color}>
              <label className="" style={color}>
      ...
      product.hasOwnProperty("previous_price") &&
      ...
      return (
        <label className="fs-18px">
          ...
          <label>
            {" "}
            ({(100 * (1 - product.price / product.previous_price)).toFixed(2)}%
            Off){" "}
          </label>
          <label>
            <del style={color}>
  ...
  return (
    <div className="">
      ...
      item.color && (
        <div className="ai-c mb-20px jc-b w-100per">
          <label className="mv-0px mr-5px">
            {item.color_group_name ? item.color_group_name : "Color"}:{" "}
          </label>
          <div className="ai-c">
        ...
        <div className="ai-c h-25px mv-15px jc-c">
          <div className="custom-select">
            <select
              ...
              onChange={e => add_item(e, set_items, list_items)}
            >
