...
router
  .route("/monthly_expenses")
  .put(expense_controller.findAllByDate_expenses_c);
router
  .route("/yearly_expenses")
  .put(expense_controller.findAllByDate_expenses_c);
router
  .route("/")
...
router
  .route("/create_all_expenses_s")
  .post(expense_controller.create_all_expenses_c);
router
  .route("/total_expenses")
  .get(expense_controller.findAllByDate_expenses_c);
